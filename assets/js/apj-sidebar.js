...
(function () {
  ...
  const FALLBACK_MODULES = [
    ...
    { MODULE_ID:'MOD-009', APP_GROUP:'ABSENSI', MODULE_KEY:'ABSENSI_DIRI', MODULE_NAME:'Check In / Out', PARENT_MENU:'Absensi', URL:'absensi.html', PERMISSION_KEY:'absensiDiri', MENU_ORDER:100, IS_MENU:'Y', STATUS:'AKTIF', ICON:'attendance' },
    { MODULE_ID:'MOD-010', APP_GROUP:'ABSENSI', MODULE_KEY:'REKAP_ABSENSI', MODULE_NAME:'Rekap Absensi', PARENT_MENU:'Absensi', URL:'', PERMISSION_KEY:'absensiAdmin', MENU_ORDER:110, IS_MENU:'Y', STATUS:'NONAKTIF', ICON:'report' },
