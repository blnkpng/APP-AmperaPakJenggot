...
function apjMarkGuideSeen(pageKey) {
  try { localStorage.setItem(apjGuideSeenKey(pageKey), 'true'); } catch (err) {}
    ...
    document.addEventListener('DOMContentLoaded', () => {
      ...
      const canAccess = (window.APJPermissionSync && APJPermissionSync.hasAny) ? APJPermissionSync.hasAny('transferItem') : (isOwner || perms.transferItem === 'Y' || perms.transferItem === true || perms.transferProduksi === 'Y' || perms.transferProduk === 'Y');
      if (!canAccess) {
